...
#define PORTD_PIN2_DIR 		DIO_INPUT		//EXTI0
#define PORTD_PIN3_DIR 		DIO_INPUT		//EXTI1
...
#define PORTB_PIN2_INITAL_VALUE 		DIO_HIGH		//EXTI2
...
#define PORTC_PIN2_INITAL_VALUE 		DIO_HIGH
#define PORTC_PIN3_INITAL_VALUE 		DIO_HIGH
#define PORTC_PIN4_INITAL_VALUE 		DIO_HIGH
#define PORTC_PIN5_INITAL_VALUE 		DIO_HIGH
...
#define PORTD_PIN2_INITAL_VALUE 		DIO_HIGH		//EXTI0
#define PORTD_PIN3_INITAL_VALUE 		DIO_HIGH		//EXTI1
#define PORTD_PIN4_INITAL_VALUE 		DIO_HIGH
#define PORTD_PIN5_INITAL_VALUE 		DIO_HIGH
#define PORTD_PIN6_INITAL_VALUE 		DIO_HIGH
#define PORTD_PIN7_INITAL_VALUE 		DIO_HIGH
